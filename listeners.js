...
$(".pokemon-link").on("click", function(e){
    ...
    $(`#pokemon-info-${area}`).html(`<div id="info"><div><span class="statHeading">hp</span>: ${trainer.myPokemon[thisPokemon].hp}</div><div><span class="statHeading">attack</span>: ${trainer.myPokemon[thisPokemon].attack}</div><div><span class="statHeading">defense</span>: ${trainer.myPokemon[thisPokemon].defense}</div><div><span class="statHeading">abilities</span>: <span id="abilities-${area}"></span></div></div>`)
